...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Punisher Channel", "https://t.me/PunisherProjects")
    buttons.buildbutton("Punisher Group", "https://t.me/Punisherdiscussion")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f"""
<b>I'm Alive..</b> 🙂
<b>I Can Leech All Your Links Along With Google Drive Links With Multiple Features Support!</b> 🙃
'''
        sendMarkup(start_string, context.bot, update.message, reply_markup)
    else:
        sendMarkup(
            "<b>Bot Started Successfully In Your PM ✅\n\nNow, Return To <u>Leech Group</u> To Use Me 👀</b>",
            context.bot,
            update.message,
            reply_markup,
        )
...
help_admin = telegraph.create_page(
    title='😄 Punisher-Cloud-Leech Help',
