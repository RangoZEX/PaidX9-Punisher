...
def getHerokuDetails(h_api_key, h_app_name):
    ...
    try:
        ...
        if EMOJI_THEME is True:
            ...
            abc += f'<b></b>\n'
            abc += f'<b>╭─《 SERVER STATISTICS》</b>\n'
            abc += f'<b>│</b>\n'
            abc += f"<b>├ Total Dyno Hours:</b> {get_readable_time(account_quota)}\n"
            abc += f"<b>├ Running From:</b> {get_readable_time(quota_used)}\n"
            abc += f"<b>├ Remaining:</b> {get_readable_time(quota_remain)}\n"
        # App Quota
        AppQuotaUsed = 0
        OtherAppsUsage = 0
...
IMAGE_X = "https://telegra.ph/file/26166a9d7e90ea8312216.jpg"
...
def stats(update, context):
    ...
    if EMOJI_THEME is True:
            ...
            stats = f'<b>╭──《 Bᴏᴛ Sᴛᴀᴛɪsᴛɪᴄs 》</b>\n' \
                    f'<b>│</b>\n' \
                    f'<b>├ Commit Date:</b> <i>{last_commit}</i>\n'\
                    f"<b>├━━━━━━━━━━━━━━━</b>\n" \
                    ...
                    f"<b>├━━━━━━━━━━━━━━━</b>\n" \
                    f"<b>├ Cᴏʀᴇ Iɴғᴏ :</b>\n" \
                    f'<b>├ Physical:</b> {p_core} ✦ <b>Total:</b> {t_core}\n'\
                    f"<b>├━━━━━━━━━━━━━━━</b>\n" \
                    f"<b>├ Rᴀᴍ Iɴғᴏ :</b>\n" \
...
def start(update, context):
    ...
    if EMOJI_THEME is True:
        ...
        buttons.buildbutton("DATABASE 🗃️", "https://t.me/FilesSearchBot")
        buttons.buildbutton("DUMMY 🗑️", "https://t.me/PaidDumb")
...
𝗪𝗵𝗮𝘁'𝘀 𝗴𝗼𝗶𝗻𝗴 𝗼𝗻?
𝗪𝗵𝘆 𝗽𝗲𝗼𝗽𝗹𝗲 𝗮𝗿𝗲 𝗯𝗲𝗵𝗮𝘃𝗶𝗻𝗴 𝗹𝗶𝗸𝗲𝘀 𝘁𝗵𝗶𝘀?
𝗪𝗵𝗲𝗿𝗲 𝗶𝘀 𝗵𝘂𝗺𝗮𝗻𝗶𝘁𝘆?
𝗪𝗵𝗲𝗿𝗲 𝗶𝘀 𝗿𝗲𝘀𝗽𝗲𝗰𝘁?
𝗪𝗵𝗲𝗿𝗲 𝗶𝘀 𝗹𝗶𝗻𝗸?'''
        if PICS:
        ...
        if PICS:
            sendPhoto('<b>Bot Started Successfully In Your PM ✅\n\nNow, Return To <u>Leech Group</u> To Use Me 👀</b>', context.bot, update.message, photo=random.choice(PICS))
        else:
            sendMarkup('<b>Bot Started Successfully In Your PM ✅\n\nNow, Return To <u>Leech Group</u> To Use Me 👀</b>', context.bot, update.message, reply_markup)
...
help_string = '''
<b><a href='https://t.me/amcdev'>AMC PROJECTS</a></b> - Telegram MIrror & Leech Bot to Upload Your File & Link in Google Drive & Telegram
...
def bot_help(update, context):
    button = ButtonMaker()
    if EMOJI_THEME is True:
        button.buildbutton("💚 Thank You", f"https://graph.org/{help_user}")
        button.buildbutton("🛡️ Maintainer", f"https://graph.org/{help_admin}")
    else:
