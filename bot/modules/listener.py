...
from bot.helper.telegram_helper.message_utils import sendMessage, sendMarkup, delete_all_messages, update_all_messages, auto_delete_message, auto_delete_upload_message, sendPhoto
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name):
        ...
        if AUTO_DELETE_UPLOAD_MESSAGE_DURATION != -1:
            ...
            if self.message.chat.type == 'private':
                ...
                if EMOJI_THEME is True:
                    ...
                    warnmsg = f'\n<b>This Message Will Auto Delete From This Group In <i>{auto_delete_message} Mins.</i></b>\n'
        else:
            warnmsg = ''
        if BOT_PM and self.message.chat.type != 'private':
            if EMOJI_THEME is True:
                ...
                pmwarn = f"\n<b>I Have Sent Your Leeched Files In PM.</b>\n\n"
        ...
        if LEECH_LOG and self.message.chat.type != 'private':
            if EMOJI_THEME is True:
                ...
                logleechwarn = f"<b>Join <a href=\"{LEECH_LOG_URL}\">Trash Logs</a> For The Leeched Files.</b>\n"
        elif self.message.chat.type == 'private':
            logleechwarn = ''
        else:
            logleechwarn = ''
                ...
                try:
                    ...
                    if is_magnet(mesg):
                        link = telegraph.create_page(
                            title='Punisher-Cloud Source Link',
                            content=mesg,
                        )["path"]
