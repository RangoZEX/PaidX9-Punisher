...
def _mirror_leech(bot, message, isZip=False, extract=False, isQbit=False, isLeech=False):
    ...
    if FSUB:
        try:
            ...
            if user.status not in ("member", "creator", "administrator", "supergroup"):
                ...
                buttons.buildbutton("Punisher Projects", f"https://t.me/{chat_u}")
                help_msg = f"<b>Hey {uname}️,\nIf You Want To Use Me, You Have To Join Our Updates Channel.</b>"
    ...
    if BOT_PM and message.chat.type != 'private':
        try:
            ...
            buttons.buildbutton("Start Bot In PM", f"{botstart}")
    ...
    if not is_url(link) and not is_magnet(link):
        ...
        if isQbit:
            ...
            help_msg = '''<b>Reply with Link Bro</b>\n\n👉 <a href="https://telegra.ph/HOW-TO-USE-BOT-01-15">𝐇𝐎𝐖 𝐓𝐎 𝐔𝐒𝐄❓</a>'''
