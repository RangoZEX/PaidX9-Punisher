...
class _BotCommands:
    def __init__(self):
        ...
        self.LeechSetCommand = getCommand('LEECHSET_COMMAND', f'setting{CMD_INDEX}')
        self.SetThumbCommand = getCommand('SETTHUMB_COMMAND', f'savethumb{CMD_INDEX}')
        self.UsageCommand = getCommand('USAGE_COMMAND', f'usage{CMD_INDEX}')
        self.LeechCommand = getCommand('LEECH_COMMAND', f'leech{CMD_INDEX}')
        self.UnzipLeechCommand = getCommand('UNZIPLEECH_COMMAND', f'extract{CMD_INDEX}')
        self.ZipLeechCommand = getCommand('ZIPLEECH_COMMAND', f'archive{CMD_INDEX}')
        self.QbLeechCommand = getCommand('QBLEECH_COMMAND', f'qbleech{CMD_INDEX}')
        self.QbUnzipLeechCommand = getCommand('QBZIPLEECH_COMMAND', f'qb_extract{CMD_INDEX}')
        self.QbZipLeechCommand = getCommand('QBUNZIPLEECH_COMMAND', f'qbzipleech{CMD_INDEX}')
        self.LeechWatchCommand = getCommand('LEECHWATCH_COMMAND',  f'ytleech{CMD_INDEX}')
