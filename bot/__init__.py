...
try:
    ...
    if len(AUTHOR_NAME) == 0:
        AUTHOR_NAME = 'Punisher Cloud'
except KeyError:
    AUTHOR_NAME = 'Punisher Cloud'
try:
    AUTHOR_URL = getConfig('AUTHOR_URL')
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/PunisherProjects'
except KeyError:
    AUTHOR_URL = 'https://t.me/PunisherProjects'
try:
    GD_INFO = getConfig('GD_INFO')
    if len(GD_INFO) == 0:
        GD_INFO = 'Uploaded by PunisherCloud Leech Bot'
except KeyError:
    GD_INFO = 'Uploaded by PunisherCloud Leech Bot'
try:
    TITLE_NAME = getConfig('TITLE_NAME')
    if len(TITLE_NAME) == 0:
        TITLE_NAME = 'PunisherCloud'
except KeyError:
    TITLE_NAME = 'PunisherCloud'
try:
    ...
    START_BTN1_NAME = 'Punisher Channel'
    START_BTN1_URL = 'https://t.me/PunisherProjects'
...
try:
    ...
    START_BTN2_NAME = 'Punisher Group'
    START_BTN2_URL = 'https://t.me/Punisherdiscussion'

try:
    CREDIT_NAME = getConfig('CREDIT_NAME')
    if len(CREDIT_NAME) == 0:
        CREDIT_NAME = 'PunisherCloud'
except KeyError:
    CREDIT_NAME = 'PunisherCloud'
...
try:
    ...
    log_info("CHANNEL_USERNAME not provided! Using default @PunisherProjects")
...
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @PunisherProjects")
...
try:
    ...
    IMAGE_URL = 'https://static1.srcdn.com/wordpress/wp-content/uploads/2017/02/Punisher-Logo-Quiz.jpg'
try:
